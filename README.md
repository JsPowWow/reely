...
- **3 Publishable Packages** - Ready for NPM publishing
  ...
  - `@reely/strings` - String manipulation utilities
  - `@reely/async` - Async utility functions with retry logic
  - `@reely/colors` - Color conversion and manipulation utilities

- **1 Internal Library**
  - `@reely/utils` - Shared utilities (private, not published)
...
| -------------- | --------------- | ---------------------- |
| `@reely/utils`   | `scope:shared`  | Nothing (base library) |
| `@reely/strings` | `scope:strings` | `scope:shared`         |
| `@reely/async`   | `scope:async`   | `scope:shared`         |
| `@reely/colors`  | `scope:colors`  | `scope:shared`         |
...
1. Try importing `@reely/colors` into `@reely/strings`
